...
public class CreateLoanReportDocumentTest
{
  ...
  private CreateLoanReportDocument useCase;
  ...
  public void setUp()
  {
    ...
    useCase = new CreateLoanReportDocument(authenticationService, authorizationService, caseService, documentRepository);
  }

  @Test(expected = NullPointerException.class)
  public void when_authentication_service_is_null()
  {
    new CreateLoanReportDocument(null, authorizationService, caseService, documentRepository);
  }

  @Test(expected = NullPointerException.class)
  public void when_authorization_service_is_null()
  {
    new CreateLoanReportDocument(authenticationService, null, caseService, documentRepository);
  }

  @Test(expected = NullPointerException.class)
  public void when_case_service_is_null()
  {
    new CreateLoanReportDocument(authenticationService, authorizationService, null, documentRepository);
  }

  @Test(expected = NullPointerException.class)
  public void when_document_repository_is_null()
  {
    new CreateLoanReportDocument(authenticationService, authorizationService, caseService, null);
  }
...
//  Use Case has 'if' statement that checks if the string is blank. Test is provided to complete the line coverage. GetVariables will throw UseCaseException.
  @Test
