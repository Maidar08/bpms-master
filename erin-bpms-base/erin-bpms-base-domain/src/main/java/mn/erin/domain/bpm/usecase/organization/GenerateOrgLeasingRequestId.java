 ...
 * @author Bilguunbor
 */
public class GenerateOrgLeasingRequestId extends AbstractUseCase<GenerateOrgRequestIdInput, String>
{
  @Override
  public String execute(GenerateOrgRequestIdInput input) throws UseCaseException
  {
    ...
    {
      throw new UseCaseException(ORG_REG_NUM_NULL_ERROR_CODE, "Leasing organization register number is missing in the input!");
    }

    String branchId = input.getBranchId();
    String registrationNumber = input.getRegNumber();

    return 2 + branchId + registrationNumber;
  }
}
