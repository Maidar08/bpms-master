 ...
 */
public class GetLoanContractRequest extends AuthorizedUseCase<Void, List<LoanContractRequest>>
{
  ...
  public GetLoanContractRequest(LoanContractRequestRepository loanContractRequestRepository,
  ...
  @Override
  protected List<LoanContractRequest> executeImpl(Void input) throws UseCaseException
  {
    return new ArrayList<>(loanContractRequestRepository.findAll());
  }
}
