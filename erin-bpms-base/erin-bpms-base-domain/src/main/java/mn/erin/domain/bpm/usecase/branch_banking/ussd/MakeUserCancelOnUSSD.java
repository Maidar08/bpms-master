...
public class MakeUserCancelOnUSSD extends AbstractUseCase<Map<String, String>, Object>
{

  private final BranchBankingService branchBankingService;

  public MakeUserCancelOnUSSD(BranchBankingService branchBankingService)
  {
  ...
  public Boolean execute(Map<String, String> input) throws UseCaseException
  {
    ...
    try
    {
      return this.branchBankingService.makeUserCancel(input.get(ID), input.get(BRANCH_NUMBER), input.get(INSTANCE_ID));
    }
