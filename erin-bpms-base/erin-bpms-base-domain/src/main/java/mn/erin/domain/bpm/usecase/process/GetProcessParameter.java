 ...
 * @author Tamir
 */
public class GetProcessParameter extends AbstractUseCase<GetProcessParameterInput, GetProcessParameterOutput>
{
  private final ProcessRepository processRepository;

  public GetProcessParameter(ProcessRepository processRepository)
  {
  ...
  public GetProcessParameterOutput execute(GetProcessParameterInput input) throws UseCaseException
  {
    ...
    try
    {
      Process returnedProcess = processRepository.filterByInstanceIdAndEntityType(input.getInstanceId(), input.getParameterEntityType());
