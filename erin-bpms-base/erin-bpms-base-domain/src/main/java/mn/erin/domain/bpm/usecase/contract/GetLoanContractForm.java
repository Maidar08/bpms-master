 ...
 */
public class GetLoanContractForm extends AuthorizedUseCase<LoanContractParameterInput, LoanContractParameter>
{
  private static final Permission permission = new AimModulePermission("GetLoanContractRequest");
  private final LoanContractParameterRepository loanContractParameterRepository;

  public GetLoanContractForm(LoanContractParameterRepository loanContractParameterRepository,
  ...
  @Override
  protected LoanContractParameter executeImpl(LoanContractParameterInput input) throws UseCaseException
  {
    try
    {
      return loanContractParameterRepository.getByInstanceIdAndDefKey(input.getProcessInstanceId(), input.getDefKey());
    }
