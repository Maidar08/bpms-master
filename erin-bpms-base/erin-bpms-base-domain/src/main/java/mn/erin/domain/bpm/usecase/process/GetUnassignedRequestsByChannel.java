 ...
 * @author Zorig
 */
public class GetUnassignedRequestsByChannel extends AuthorizedUseCase<GetUnassignedRequestsByChannelInput, Collection<ProcessRequest>>
{
  private static final Permission permission = new BpmModulePermission("GetUnassignedRequestsByChannel");
  private final ProcessRequestRepository processRequestRepository;

  public GetUnassignedRequestsByChannel(AuthenticationService authenticationService,
  ...
  @Override
  protected Collection<ProcessRequest> executeImpl(GetUnassignedRequestsByChannelInput input) throws UseCaseException
  {
