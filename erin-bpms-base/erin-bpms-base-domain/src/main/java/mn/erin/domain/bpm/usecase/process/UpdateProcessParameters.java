 ...
 * @author Zorig
 */
public class UpdateProcessParameters extends AuthorizedUseCase<UpdateProcessParametersInput, UpdateProcessParametersOutput>
{
  ...
  public UpdateProcessParameters(AuthenticationService authenticationService,
  ...
  protected UpdateProcessParametersOutput executeImpl(UpdateProcessParametersInput input) throws UseCaseException
  {
    ...
    try
    {
      ...
      int numUpdated = processRepository.updateParameters(input.getProcessInstanceId(), input.getParameters());
