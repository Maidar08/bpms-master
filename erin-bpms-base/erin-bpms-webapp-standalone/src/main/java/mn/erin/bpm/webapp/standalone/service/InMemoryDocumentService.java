...
public class InMemoryDocumentService implements DocumentService
{
  ...
  @Override
  public String downloadPaymentScheduleAsBase64(String accountNumber, String repaymentType, Map<String, String> paymentScheduleInfo, String processType) throws BpmServiceException
  {
    throw new UnsupportedOperationException();
  }
