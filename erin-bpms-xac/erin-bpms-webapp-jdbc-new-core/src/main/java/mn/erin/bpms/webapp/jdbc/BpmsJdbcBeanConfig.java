...
package mn.erin.bpms.webapp.jdbc;
...
@Import({ BpmModuleJdbcBeanConfig.class, AdRealmShiroBeanConfig.class, BpmsBeanConfig.class,
    OrganizationRequestRestBeanConfig.class, CamundaLoanConsumptionBeanConfig.class, CamundaLoanContractBeanConfig.class, CamundaDirectOnlineBeanConfig.class,
    XacBnplBeanConfig.class, LoanRequestRestBeanConfig.class, DirectOnlineLoanRestApi.class,
...
public class BpmsJdbcBeanConfig
{
  @Bean
  @Inject
  ...
  // this works just only for tomcat spring process application
  @Bean
  public SpringProcessApplication processLoanApplication()
  {
