...
public class CreateCollateralLoanAccountTaskMicroTest
{
  ...
  private CreateCollateralLoanAccountTaskMicro createLoanAccountTask;
  ...
  public void setUp()
  {
    ...
    createLoanAccountTask = new CreateCollateralLoanAccountTaskMicro(newCoreBankingService, coreBankingService, authenticationService, membershipRepository, processRepository);
  ...
  public void when_creating_account_score_integer_type() throws Exception
  {
    ...
    Mockito.when(delegateExecution.getVariable("isLoanAccountCreate")).thenReturn(true);
    Mockito.when(delegateExecution.getVariable("loanProduct")).thenReturn("EG50-Something");
    Mockito.when(delegateExecution.getVariable("acceptedLoanAmount")).thenReturn(Long.valueOf(123));
    Mockito.when(delegateExecution.getVariable("yearlyInterestRate")).thenReturn(new BigDecimal(12.3));
    getBranchMock();
