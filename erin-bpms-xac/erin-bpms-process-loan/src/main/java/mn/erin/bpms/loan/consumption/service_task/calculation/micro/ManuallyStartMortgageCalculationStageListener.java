...
import static mn.erin.bpms.loan.consumption.constant.CamundaActivityIdConstants.ACTIVITY_ID_MORTGAGE_LOAN_CALCULATION_STAGE;
...
public class ManuallyStartMortgageCalculationStageListener implements CaseExecutionListener
{
  @Override
  public void notify(DelegateCaseExecution delegateCaseExecution) throws Exception
  {
    ...
    for (CaseExecution enabledExecution : enabledExecutions)
    {
      ...
      if (activityId.equalsIgnoreCase(ACTIVITY_ID_MORTGAGE_LOAN_CALCULATION_STAGE))
      {
