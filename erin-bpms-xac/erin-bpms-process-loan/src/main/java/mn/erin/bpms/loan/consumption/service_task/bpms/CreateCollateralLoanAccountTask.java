 ...
 * @author Zorig
 */
public class CreateCollateralLoanAccountTask implements JavaDelegate
{
  private static final Logger LOGGER = LoggerFactory.getLogger(CreateCollateralLoanAccountTask.class);
  ...
  public CreateCollateralLoanAccountTask(NewCoreBankingService newCoreBankingService, CoreBankingService coreBankingService, AuthenticationService authenticationService,
  ...
  public void execute(DelegateExecution execution) throws Exception
  {
    ...
    LOGGER.info("#########  Creating Loan Account with collateral(s).. Register Number: " + registrationNumber + ", Request ID: " + requestId + " , User ID: "
        + userId);
    ...
    String school = (String) execution.getVariable("surguuli");
    ...
    accountCreationInformation
        .put("SURGUULI", getUDFieldValueId("SURGUULI", school, getUDFieldsByProductCodeOutput));
