 ...
 * @author Zorig
 */
public class LoanDecisionTask implements JavaDelegate
{
  ...
  public LoanDecisionTask(AuthenticationService authenticationService, AuthorizationService authorizationService,
