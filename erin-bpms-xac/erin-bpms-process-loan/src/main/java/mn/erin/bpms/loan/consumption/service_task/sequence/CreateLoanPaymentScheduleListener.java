 ...
 * @author Zorig
 */
public class CreateLoanPaymentScheduleListener implements CaseExecutionListener
{
  private static final Logger LOGGER = LoggerFactory.getLogger(CreateLoanPaymentScheduleListener.class);
  ...
  public CreateLoanPaymentScheduleListener(AuthenticationService authenticationService, AuthorizationService authorizationService,
