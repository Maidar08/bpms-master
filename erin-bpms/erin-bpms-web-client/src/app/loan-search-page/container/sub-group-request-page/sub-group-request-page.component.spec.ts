...
import {SubGroupRequestPageComponent} from './sub-group-request-page.component';
...
describe('SubGroupRequestPageComponent', () => {
  let component: SubGroupRequestPageComponent;
  let fixture: ComponentFixture<SubGroupRequestPageComponent>;
  let sb;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ SubGroupRequestPageComponent ],
      imports: [
        HttpClientModule,
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SubGroupRequestPageComponent);
    component = fixture.componentInstance;

    spyOn(sb, 'getSubGroupRequest').and.returnValue({ subscribe: () => {} });
  ...
  it('should get requests', () => {
    component.ngOnInit();
    expect(sb.getSubGroupRequest).toHaveBeenCalled();
  });
});
